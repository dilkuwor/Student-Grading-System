...
-- --------------------------------------------------
-- Date Created: 01/05/2014 20:57:01
-- Generated from EDMX file: C:\Users\Dil Kuwor\Documents\GitHub\Student-Grading-System\GPA\GPA\Models\GPADataModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_CourseUser_Courses]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CourseUser] DROP CONSTRAINT [FK_CourseUser_Courses];
GO
IF OBJECT_ID(N'[dbo].[FK_CourseUser_Registration]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CourseUser] DROP CONSTRAINT [FK_CourseUser_Registration];
GO
...
IF OBJECT_ID(N'[dbo].[FK_GradeStudent_GPA]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StudentGrade] DROP CONSTRAINT [FK_GradeStudent_GPA];
GO
...
IF OBJECT_ID(N'[dbo].[FK_RoleTask_Roles]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RoleTask] DROP CONSTRAINT [FK_RoleTask_Roles];
GO
IF OBJECT_ID(N'[dbo].[FK_RoleTask_Tasks]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[RoleTask] DROP CONSTRAINT [FK_RoleTask_Tasks];
GO
IF OBJECT_ID(N'[dbo].[FK_Student_GPACourse]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[StudentGrade] DROP CONSTRAINT [FK_Student_GPACourse];
GO
...
GO
IF OBJECT_ID(N'[dbo].[CourseUser]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CourseUser];
GO
...
GO
IF OBJECT_ID(N'[dbo].[StudentGrade]', 'U') IS NOT NULL
